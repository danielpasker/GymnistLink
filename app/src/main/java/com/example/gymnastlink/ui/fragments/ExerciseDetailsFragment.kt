...
class ExerciseDetailsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cardView?.setBackgroundResource(R.drawable.gradient_background_blue)
        val fab = view?.findViewById<FloatingActionButton>(R.id.exercise_details_save_fab)
        fab?.background = ContextCompat.getDrawable(requireContext(), R.drawable.gradient_background_blue)
